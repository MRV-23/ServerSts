...
<head>
  ...
  <title>STS TRACKING SYSTEM </title>
  ...
  <link rel="stylesheet" href="../../views/css/styleSTS.css">
...
<div class="wrapper">
      ...
      <section class="content">
        <div class="box">
          <div class="box-header with-danger ">
              <h3 class="box-title text"><i class="fa fa-free-code-camp icono-asistencias" ></i > Inicioo </h3>
                ...
                <div class="box-body col-md-12">
                  <div class="row">
                      <div class="col-md-12 "style='text-align: center;' >
                          <img src="img/logosts.png" style="text-align: center;">
                      </div>
                  </div>
                </div>
              </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="https://adminlte.io">STS SKY TRACKING</a>.</strong> All rightsreserved.
  </footer>
