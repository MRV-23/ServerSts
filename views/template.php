...
<head>
  ...
  <link rel="stylesheet" href="viewsviews//css/skins/_all-skins.min.css">
  <!-- Morris chart -->
  ...
  <body class="hold-transition skin-blue sidebar-mini " style=" background: url('views/img/sts1.jpg') ">
