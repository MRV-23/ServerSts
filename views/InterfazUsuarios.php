...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="#" class="sidebar-toggle menucabecera" data-toggle="push-menu" role="button"> <!-- Este son las 3 rallas para hacer elmenu oculto o no -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left barra-oculta">
          <p class="" style="color: white;"  >STS TRACKING SYSTEM</p>
